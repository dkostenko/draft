...
\begin{figure}[h]
	\begin{minipage}[h]{0.2\linewidth}
		\center{\includegraphics[width=0.2\linewidth]{frame1} \\ a)}
	\end{minipage}
	\hfill

	\begin{minipage}[h]{0.2\linewidth}
		\center{\includegraphics[width=0.2\linewidth]{frame2} \\ b)}
	\end{minipage}
	\hfill

	\begin{minipage}[h]{0.2\linewidth}
		\center{\includegraphics[width=0.2\linewidth]{frame3} \\ c)}
	\end{minipage}
	\hfill

	\begin{minipage}[h]{0.2\linewidth}
		\center{\includegraphics[width=0.2\linewidth]{frame4} \\ d)}
	\end{minipage}
	\hfill

	\begin{minipage}[h]{0.2\linewidth}
		\center{\includegraphics[width=0.2\linewidth]{frame_sum} \\ e)}
	\end{minipage}
...
\begin{figure}[h]
  \center{\includegraphics[width=1cm]{frame4}}
...
\center{\includegraphics[width=0.5\linewidth]{four-svyaznost.png} \\ a)}
\end{minipage}
\hfill
\begin{minipage}[h]{0.49\linewidth}
\center{\includegraphics[width=0.5\linewidth]{eight-svyaznost.png} \\ b)}
\end{minipage}
