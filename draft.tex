...
In the beginning it is nesessary to find the objects of interest, which can also be called the foreground objects.
...
\begin{figure}[h]
  \center{\includegraphics[width=10cm]{images/1.jpg}}
...
\begin{figure}[h]
  \center{\includegraphics[width=10cm]{images/2.jpg}}
  \caption{Some caption}
  \label{fig:fig2}
\end{figure}
